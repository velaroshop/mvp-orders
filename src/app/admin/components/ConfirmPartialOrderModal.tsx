    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-900 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="border-b border-zinc-700 p-3">
          <h2 className="text-base font-bold text-white">Partial Confirm</h2>
        </div>
        ...
        <div className="p-4 space-y-3">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-2.5 py-1.5 bg-zinc-800 border ${
                      errors.fullName ? "border-red-500 bg-red-500/5" : "border-zinc-700"
                    } rounded-md text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500`}
                    placeholder="Nume complet"
                  />
                </div>
                {errors.fullName && (
                  <p className="mt-0.5 text-xs text-red-400">{errors.fullName}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-9 py-1.5 bg-zinc-800 border ${
                      errors.phone ? "border-red-500 bg-red-500/5" : "border-zinc-700"
                    } rounded-md text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-60 disabled:cursor-not-allowed`}
                ...
                {errors.phone && (
                  <p className="mt-0.5 text-xs text-red-400">{errors.phone}</p>
                )}
              </div>
            </div>
          </div>
          ...
          {duplicateInfo && duplicateInfo.hasOrders && (
            <div className="flex items-start gap-2 p-2.5 bg-red-500/10 border border-red-500/30 rounded-md">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                {errors.county && (
                  <p className="mt-0.5 text-xs text-red-400">{errors.county}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.city && (
                  <p className="mt-0.5 text-xs text-red-400">{errors.city}</p>
                )}
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {/* Main Product */}
              <div className="bg-zinc-800 rounded-md p-2.5">
              ...
              {partialOrder?.upsells && partialOrder.upsells.length > 0 && (
                <div className="space-y-1.5">
                  ...
                  {partialOrder.upsells.map((upsell: any, index: number) => (
                    <div key={index} className="bg-zinc-800 rounded-md p-2.5">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="text-sm text-white font-medium">
                            {upsell.title || "—"}
              ...
              {/* Order Summary */}
              <div className="bg-zinc-800/50 rounded-md p-2.5 mt-2 space-y-1.5">
                ...
                <div className="pt-1.5 border-t border-zinc-700 flex justify-between">
        ...
        {/* Footer */}
        <div className="border-t border-zinc-700 p-3 flex justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            disabled={isConfirming}
            className="px-3 py-1.5 text-sm font-medium text-zinc-300 bg-zinc-800 border border-zinc-700 rounded-md hover:bg-zinc-700 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
