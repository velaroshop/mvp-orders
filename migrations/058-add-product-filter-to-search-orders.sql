-- Migration 058: Add product filter to search_orders RPC
-- Allows filtering orders by product SKU (main product or upsells)

-- Drop old function signature (6 params) to avoid ambiguity
