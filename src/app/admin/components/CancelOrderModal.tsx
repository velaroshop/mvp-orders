  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md bg-white rounded-lg shadow-xl">
        {/* Header - Red for cancel */}
        <div className="bg-red-600 text-white px-6 py-4 flex items-center justify-between">
          <h2 className="text-xl font-semibold">ANULARE COMANDĂ</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <p className="text-sm text-zinc-600 mb-4">
            Adaugă un motiv pentru anularea comenzii (opțional):
          </p>
          ...
          <div className="mb-4 space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-zinc-300 px-3 py-2 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-red-500"
          ...
          <div className="flex justify-end gap-3">
            ...
            >
              {isSubmitting ? "Se anulează..." : "Anulează Comanda"}
            </button>
          </div>
        </form>
      </div>
